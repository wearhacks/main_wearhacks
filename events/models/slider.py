...
class Slider(models.Model):
    ...
    overlay_percentage = models.DecimalField(default=0, max_digits=2, decimal_places=2, blank=False, help_text="Specify background opacity 0~>1.  0 -> Clear image, 1-> completely dark")
